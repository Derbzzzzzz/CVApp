      ...
      <div className="container">
        ...
        <form onSubmit={(e) => formSubmit(e, props)}>
            <div className="form-group">
                <h4><label className="required" htmlFor="org">Company/Organization</label></h4>
                <input type="text" className="form-control" id="org" placeholder="Company/Organization Name" defaultValue={i >= 0 ? data.experiences[i].org : null} autoComplete="off" required/>
            </div>
            <div className="form-group">
                <h4><label className="required" htmlFor="position">Position</label></h4>
                <input type="text" className="form-control" id="position" placeholder="Position Title" defaultValue={i >= 0 ? data.experiences[i].position : null} autoComplete="off" required/>
            </div>
            <div className="row">
                <div className="form-group col-md-6">
                    <h4><label className="required" htmlFor="startDate">Start Date</label></h4>
                    <input type="date" className="form-control" id="workStartDate" defaultValue={i >= 0 ? data.experiences[i].startDate : null} required/>
                </div>
                <div className="form-group col-md-6">
                    <h4><label htmlFor="endDate">End Date</label></h4>
                    <input type="date" className="form-control" id="workEndDate" defaultValue={i >= 0 ? data.experiences[i].org : null}/>
                </div>
            </div>
            <div className="form-group">
                <h4><label className="required" htmlFor="responsibilities">Responsibilities</label></h4>
                <textarea className="form-control" id="responsibilities" rows="2" defaultValue={i >= 0 ? data.experiences[i].org : null} required></textarea>
            </div>
